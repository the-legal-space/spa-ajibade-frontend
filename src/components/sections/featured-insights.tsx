  ...
  return (
    <section {...autoplay} className="relative -mt-[70px] overflow-hidden bg-ink pt-[70px] text-white" aria-roledescription="carousel" aria-label="Featured insights">
      ...
      <div className="container-site relative py-14 md:px-16 md:py-16">
        <article key={item.id} className="grid animate-fade-in items-center gap-8 md:grid-cols-2" aria-roledescription="slide" aria-label={`${i + 1} of ${items.length}`}>
          <div>
            ...
            <div className="mt-5 flex items-center justify-between gap-4">
              ...
              <Link href={`/insights/${item.slug}`} className="inline-flex items-center gap-1 rounded-[4px] border border-white/20 px-3 py-2 text-xs hover:bg-white/10">
          ...
          <div className="aspect-[513/306] overflow-hidden">
            <Media image={item.coverImage} placeholder="dark" priority sizes="(min-width:768px) 50vw, 100vw" />
          </div>
        </article>
